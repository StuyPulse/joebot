...
public class Skeleton {
   ...
   public static class tJointTypes{
   	...
   	public Joint GetHandRight() { return skeleton[tJointTypes.kHandRight.value]; }
	public Joint GetHandLeft() {  return skeleton[tJointTypes.kHandLeft.value]; }
	public Joint GetWristRight() {  return skeleton[tJointTypes.kWristRight.value]; }
	public Joint GetWristLeft() {  return skeleton[tJointTypes.kWristLeft.value]; }
	public Joint GetElbowLeft() {  return skeleton[tJointTypes.kElbowLeft.value]; }
	public Joint GetElbowRight() {  return skeleton[tJointTypes.kElbowRight.value]; }
	public Joint GetShoulderLeft() {  return skeleton[tJointTypes.kShoulderLeft.value]; }
	public Joint GetShoulderRight() {  return skeleton[tJointTypes.kShoulderRight.value]; }
	public Joint GetShoulderCenter() {  return skeleton[tJointTypes.kShoulderCenter.value]; }
	public Joint GetHead() {  return skeleton[tJointTypes.kHead.value]; }
	public Joint GetSpine() {  return skeleton[tJointTypes.kSpine.value]; }
	public Joint GetHipCenter() {  return skeleton[tJointTypes.kHipCenter.value]; }
	public Joint GetHipRight() {  return skeleton[tJointTypes.kHipRight.value]; }
	public Joint GetHipLeft() {  return skeleton[tJointTypes.kHipLeft.value]; }
	public Joint GetKneeLeft() {  return skeleton[tJointTypes.kKneeLeft.value]; }
	public Joint GetKneeRight() {  return skeleton[tJointTypes.kKneeRight.value]; }
	public Joint GetAnkleLeft() {  return skeleton[tJointTypes.kAnkleLeft.value]; }
	public Joint GetAnkleRight() {  return skeleton[tJointTypes.kAnkleRight.value]; }
	public Joint GetFootLeft() {  return skeleton[tJointTypes.kFootLeft.value]; }
	public Joint GetFootRight() {  return skeleton[tJointTypes.kFootRight.value]; }
	public Joint GetJoint(tJointTypes index) { return skeleton[index.value]; }

        public tTrackState GetTrackState(){ return trackState;}
